 ...
 * that built it never runs. Since plan 044 the durable [TestLocationSidecar] file is the
 * **primary** finalizer channel (it survives the composite-build param freeze and a CC hit); this
 * service param is the classpath-path fallback.
 */
