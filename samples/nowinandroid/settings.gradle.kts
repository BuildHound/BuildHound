...
buildhound {
    ...
    // OFF BY DEFAULT and dormant — no internal API is touched until you flip one, and flipping one is
    // the per-feature consent. Enabling a toggle logs a one-time "reads internal Gradle APIs" notice.
    internalAdapters {
