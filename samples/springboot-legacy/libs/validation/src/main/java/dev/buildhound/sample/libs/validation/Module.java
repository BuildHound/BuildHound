package dev.buildhound.sample.libs.validation;

/** Generated module marker — :libs:validation. The reference below forces a real compile-time edge to a
