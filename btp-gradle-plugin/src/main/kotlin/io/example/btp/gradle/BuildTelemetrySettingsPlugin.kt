 ...
 */
abstract class BuildTelemetrySettingsPlugin @Inject constructor(
    ...
    override fun apply(settings: Settings) {
        val extension = settings.extensions.create("buildTelemetry", BuildTelemetryExtension::class.java)
