...
import io.example.btp.commons.payload.TaskExecution
import io.example.btp.commons.payload.TaskOutcome
...
abstract class TaskEventCollector : BuildService<BuildServiceParameters.None>, OperationCompletionListener {
    ...
    companion object {
        const val SERVICE_NAME: String = "btpTaskEventCollector"
    }
}
